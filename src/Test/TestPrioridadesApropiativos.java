...
public class TestPrioridadesApropiativos {
	...
	public static void main(String[] args) {
		...
		System.out.println(mostrarAlgoritmoPrioridadesApropiativos(admP1));
		...
		System.out.println(mostrarAlgoritmoPrioridadesApropiativos(admP2));

	}

	public static String mostrarAlgoritmoPrioridadesApropiativos(admProcesamiento admP) {
		String string = "";
		Tabla[][] tabla = admP.planificarPrioridadesApropiativos();
